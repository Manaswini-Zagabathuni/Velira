...
import {
  LayoutDashboard, Bell, Sprout, Activity,
  Calendar, Heart, LogOut, Pill
} from 'lucide-react';
...
const navItems = [
  ...
  { href: '/parent/medicines', icon: Pill, label: 'Medicines' },
  { href: '/parent/health', icon: Activity, label: 'Health Log' },
  { href: '/parent/garden', icon: Sprout, label: 'My Garden' },
  { href: '/parent/appointments', icon: Calendar, label: 'Appointments' },
];
    ...
    <div className="min-h-screen bg-sand-50 flex">
      ...
      <aside className="w-64 bg-white border-r border-velira-100 flex flex-col fixed h-full">
        <div className="px-6 py-5 border-b border-velira-100">
          ...
          <p className="font-body text-xs text-gray-400 mt-1">Parent view</p>
        </div>
        ...
        <div className="px-3 py-4 border-t border-velira-100">
          <div className="px-4 py-3 mb-2">
            ...
            {profile?.pairCode && (
              <div className="mt-2 bg-velira-50 rounded-lg px-3 py-2">
                <p className="font-body text-xs text-velira-600">Your pair code</p>
                <p className="font-mono text-sm font-medium text-velira-800 tracking-widest">{profile.pairCode}</p>
              </div>
            )}
          </div>
